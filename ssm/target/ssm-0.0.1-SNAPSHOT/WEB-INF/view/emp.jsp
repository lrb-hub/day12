...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="tbEmpAge1" class="" id="txt_search_tbEmpAge1" >-
			      <input type="text" name="tbEmpAge2" class="" id="txt_search_tbEmpAge2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">生日 </span>
			      <input type="date" name="tbEmpBirthday1" class="" id="txt_search_tbEmpBirthday1" >-
			      <input type="date" name="tbEmpBirthday2" class="" id="txt_search_tbEmpBirthday2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">性别 </span>
			      <input type="radio" name="tbEmpSex" class="" id="txt_search_tbEmpSex1" value="1">男
			      <input type="radio" name="tbEmpSex" class="" id="txt_search_tbEmpSex2" value="0">女
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_tbEmpDid" id = "txt_search_tbEmpDid">
						...
						<c:forEach items="${deptList }" var="r">
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>头像：</td>
								<td colspan="4">
									<img src="" id = "oldimg" width="50">
									<input type="file" id = "empFile" name = "empFile" required>
									<input type="hidden" id = "oldempFile" >
								</td>
							</tr>
	...
	var TableInit = function () {
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            , {
	                ...
	                title: '头像',
	                formatter: function(value,row,index){
	                	return "<img src = '/img/"+value+"' width = '50'>"
	                }
	            }
	            , {
	                field: 'tbEmpBirthday',
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            tbEmpSex: $("input[name='tbEmpSex']:checked").val(),
	            tbEmpName: $("#txt_search_tbEmpName").val(),
	            
	            age1: $("#txt_search_tbEmpAge1").val(),
	            age2: $("#txt_search_tbEmpAge2").val(),
	            tbEmpBirthday1: $("#txt_search_tbEmpBirthday1").val(),
	            tbEmpBirthday2: $("#txt_search_tbEmpBirthday2").val(),
	...
	function initEditUser(getSelection){
		...
		$('#oldempFile').val(getSelection.tbEmpImg);
		$('#oldimg').attr("src","/img/"+getSelection.tbEmpImg);
