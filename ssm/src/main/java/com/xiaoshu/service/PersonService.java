...
public class PersonService {
	...
	@Autowired
	PpersonMapper personMapper;
	
	@Autowired
	PcompanyMapper comMapper;
...
/*
	...
	public PageInfo<PpersonVo> findUserPage(PpersonVo ppersonVo, int pageNum, int pageSize, String ordername, String order) {
		...
		List<PpersonVo> userList = personMapper.findPageAll(ppersonVo);
	...
	public void updateUser(PpersonVo ppersonVo) {
		// TODO Auto-generated method stub
		personMapper.updateByPrimaryKeySelective(ppersonVo);
	}

	public void addUser(PpersonVo ppersonVo) {
		// TODO Auto-generated method stub
		personMapper.insert(ppersonVo);
	}
