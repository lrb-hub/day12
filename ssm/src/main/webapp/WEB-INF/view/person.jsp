...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_roleid" id = "txt_search_companyId">
						<option value="0">---请选择---</option>
										<c:forEach items="${comList }" var="r">
	...
	function initEditUser(getSelection){
		...
		$('#gender1').attr("checked",getSelection.gender=="男"?true:false);
		$('#gender2').attr("checked",getSelection.gender=="女"?true:false);
