...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				...
				<div class="input-group">
					...
					<input type="date" name="entrytime" class="form-control" id="txt_search_entrytime" >
				</div>
			 </div>
	...
	<!-- 新增课程和修改对话框 -->
	<div class="modal fade" id="modal_user_course" role="dialog" aria-labelledby="modal_course_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            entrytime: $("#txt_search_entrytime").val(),
